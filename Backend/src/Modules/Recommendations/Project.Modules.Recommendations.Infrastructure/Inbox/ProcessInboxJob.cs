...
namespace Project.Modules.Recommendations.Infrastructure.Inbox;
    ...
    ILogger<ProcessInboxJob> logger) : IJob
{
        ...
        IDbTransaction transaction)
    {
        string sql =
            $"""
             ...
             FROM "{Schemas.Recommendations}".inbox_messages
    ...
    private static async Task UpdateInboxMessageAsync(
        IDbConnection connection,
        IDbTransaction transaction,
        ...
        Exception? exception)
    {
        const string sql =
            $"""
            UPDATE "{Schemas.Recommendations}".inbox_messages
